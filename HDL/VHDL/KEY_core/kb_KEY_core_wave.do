...
add wave -noupdate -color {Light Steel Blue} -label match /tb_key_core/KEY_core_0/kb_regs_0/match
add wave -noupdate -color {Light Steel Blue} -label QD -radix unsigned -childformat {{/tb_key_core/KEY_core_0/kb_regs_0/QD(5) -radix unsigned} {/tb_key_core/KEY_core_0/kb_regs_0/QD(4) -radix unsigned} {/tb_key_core/KEY_core_0/kb_regs_0/QD(3) -radix unsigned} {/tb_key_core/KEY_core_0/kb_regs_0/QD(2) -radix unsigned} {/tb_key_core/KEY_core_0/kb_regs_0/QD(1) -radix unsigned} {/tb_key_core/KEY_core_0/kb_regs_0/QD(0) -radix unsigned}} -subitemconfig {/tb_key_core/KEY_core_0/kb_regs_0/QD(5) {-color {Light Steel Blue} -height 15 -radix unsigned} /tb_key_core/KEY_core_0/kb_regs_0/QD(4) {-color {Light Steel Blue} -height 15 -radix unsigned} /tb_key_core/KEY_core_0/kb_regs_0/QD(3) {-color {Light Steel Blue} -height 15 -radix unsigned} /tb_key_core/KEY_core_0/kb_regs_0/QD(2) {-color {Light Steel Blue} -height 15 -radix unsigned} /tb_key_core/KEY_core_0/kb_regs_0/QD(1) {-color {Light Steel Blue} -height 15 -radix unsigned} /tb_key_core/KEY_core_0/kb_regs_0/QD(0) {-color {Light Steel Blue} -height 15 -radix unsigned}} /tb_key_core/KEY_core_0/kb_regs_0/QD
add wave -noupdate -color {Light Steel Blue} -label D -radix unsigned -childformat {{/tb_key_core/D(7) -radix unsigned} {/tb_key_core/D(6) -radix unsigned} {/tb_key_core/D(5) -radix unsigned} {/tb_key_core/D(4) -radix unsigned} {/tb_key_core/D(3) -radix unsigned} {/tb_key_core/D(2) -radix unsigned} {/tb_key_core/D(1) -radix unsigned} {/tb_key_core/D(0) -radix unsigned}} -subitemconfig {/tb_key_core/D(7) {-color {Light Steel Blue} -height 15 -radix unsigned} /tb_key_core/D(6) {-color {Light Steel Blue} -height 15 -radix unsigned} /tb_key_core/D(5) {-color {Light Steel Blue} -height 15 -radix unsigned} /tb_key_core/D(4) {-color {Light Steel Blue} -height 15 -radix unsigned} /tb_key_core/D(3) {-color {Light Steel Blue} -height 15 -radix unsigned} /tb_key_core/D(2) {-color {Light Steel Blue} -height 15 -radix unsigned} /tb_key_core/D(1) {-color {Light Steel Blue} -height 15 -radix unsigned} /tb_key_core/D(0) {-color {Light Steel Blue} -height 15 -radix unsigned}} /tb_key_core/D
