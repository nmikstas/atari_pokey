...
add wave -noupdate -color Magenta -label {SKCTLS[6..4]} /tb_ser_clock_gen/ser_clock_gen_0/SKCTLS
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {747552057 ps} 0}
...
update
WaveRestoreZoom {686005231 ps} {865968899 ps}
