...
add wave -noupdate -format Analog-Step -label AUD1 -max 15.0 -radix unsigned /tb_pokey_top/pokey_top_0/AUD_core_0/AUD1
add wave -noupdate -format Analog-Step -label AUD2 -max 15.0 -radix unsigned /tb_pokey_top/pokey_top_0/AUD_core_0/AUD2
add wave -noupdate -format Analog-Step -label AUD3 -max 15.0 -radix unsigned /tb_pokey_top/pokey_top_0/AUD_core_0/AUD3
add wave -noupdate -format Analog-Step -label AUD4 -max 15.0 -radix unsigned /tb_pokey_top/pokey_top_0/AUD_core_0/AUD4
add wave -noupdate -format Analog-Step -label audio -max 23.0 -radix unsigned /tb_pokey_top/audio
...
WaveRestoreCursors {{Cursor 1} {24629629630 ps} 0}
