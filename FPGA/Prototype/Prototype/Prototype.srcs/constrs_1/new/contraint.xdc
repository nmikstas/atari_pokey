...
set_false_path -from Aint_reg[1]/C -to AQ_reg[1]/D;
set_false_path -from Aint_reg[0]/C -to AQ_reg[0]/D;
set_false_path -from Aint_reg[3]/C -to AQ_reg[3]/D;
set_false_path -from Aint_reg[2]/C -to AQ_reg[2]/D;
set_false_path -from clk179 -to Qprep_reg/D;
set_false_path -from clk179 -to Qpren_reg/D;
