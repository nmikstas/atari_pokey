...
HD_PWD='D:/work/Arcade+Projects/atari_pokey/FPGA/Prototype/Prototype/Prototype.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log POKEY_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source POKEY_Top.tcl
